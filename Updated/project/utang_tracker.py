...
class UtangTracker:
    ...
    def show_dashboard(self):
        ...
        self.search_entry = ctk.CTkEntry(filter_frame, width=200, height=35)
        ...
        relationship_menu = ctk.CTkOptionMenu(filter_frame, variable=self.filter_relationship_var,
                                            ...
                                            width=150, height=35, command=self.load_debts)
        ...
        self.min_amount_entry = ctk.CTkEntry(filter_frame, width=100, height=35)
        ...
        self.max_amount_entry = ctk.CTkEntry(filter_frame, width=100, height=35)
        self.max_amount_entry.pack(side="left", padx=5)
        
        search_btn = ctk.CTkButton(filter_frame, text="Search", command=self.load_debts, width=100, height=35)
